...
public class NbTrace {
	...
	public static boolean DEBUG = true;			// Se imprimirán los logs de las clases que se encuentran en tags.
	 ...
	 * Si la actividad no ha sido asignada, no se agregar� el mensaje a
	 * adapter.
	 * 
