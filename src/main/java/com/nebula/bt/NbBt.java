...
public class NbBt extends NbCom {
    ...
    /**
     * Comenzar un intendo de conexión.
     * Este método se creará un hilo para el intendo de conexión con el dispositivo Bluetooth. El tipo de conexión que se
     ...
     * 
     * @param socket 	Socket al que se lográ conectar.
     * @param device 	Dispositivo bluetooth al que se conectá.
...
//        if (mConnectThread != null) {mConnectThread.cancel(); mConnectThread = null;}
     ...
     * Para esta especificacián recibe mensajes para cuando se encuentra un dispositivo bluetooth y cuando se finaliza el
     * escaneo.
     */
    public void onReciveBroadcastReciver(Context context, Intent intent){
        ...
        if (BluetoothDevice.ACTION_FOUND.equals(action)) {
            ...
            // Si el dispositivo bluetooth ya está pareado se pasa, porque ya de debiá agregar como un dispositivo bluetooth
            // pareado.
        ...
        // Cuando finalice la básqueda de dispositivos bluetooth.
        } else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action)) {
        	
        	// Generar evento correspondiente
        	sendMessage(NbComMsgEnum.BT_DO_DISCOVERY_FINISH, -1, -1, null, null);
        	
        	// Si no se ha encontrado ningán dispositivo bluetooth.
            if (mNewDevicesCount == 0) {
            	
            	// Generar evento para indica que no se controntrá ningun dispositivo bluetooth.
