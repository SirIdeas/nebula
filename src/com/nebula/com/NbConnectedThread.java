/* ========================================================================
 * Nebula Android Lib: NbConnectedThread v0.0.1-beta
 ...
 * y salida de datos. Este hilo se mantendrá ejecutandose mientras la comunicación esté activa. Las especificaciones de esta
...
//	        		if (Trace.DEBUG) Trace.d(this, String.format("ConnectedThread.read(%s)", bufferIn));
        	...
        	// Cuando se pierda la conexión se generará una excepcion dentro del bucle infinito por lo tanto saldrá del mismo.
