/* ========================================================================
 * Nebula Android Lib: NbCom v0.0.1-beta
...
public class NbCom {
    ...
    /**
     * Método que se llama cuando falla el intento de conexión.
    ...
    /**
     * Método que es llamado cuando se pierde la conexión.
     * Se encarga de relizar el trazado correspondiente, realizar el llamado del evento y cambiar el estado del disposiivo a
     * desconectado.
     */
     ...
     * Este método se encarga simplemente de iniciar un nuevo <code>BaseConnectedThread</code>. Este tipo de hilos son
     ...
     * Este método es llamado cuando se desea cancelar y resetear el <code>BaseConnectedThread</code> ya sea por una
     * desconexión o por parte de la aplicación.
     */
    protected void cancelConnectedThread(){
    	NbTrace.d(this, "cancelConnectedThread()");
    	
        // Cancela cualquier hilo actualmente corriendo una connexión.
     ...
     * Recibe los mismo parámetros que un corriente <code>BroadcastReceiver</code>. Este método se debe sobreescribir en las
     * especificaciones de esta clase que requieran BroadcastReceiver para permitir una mejor organización.
     * 
     * @param context	Parámetro recibido por el método <code>BroadcastReceiver#onRecibe</code>.
     * @param intent 	Parámetro recibido por el método <code>BroadcastReceiver#onRecibe</code>.
     */
     ...
     * 
     * @param out Array de bytes (<code>byte[]</code>) que se enviarán.
     */
     ...
     * Esta función solo se encarga de convertir el <code>VectorBytes</code> en un array de bytes (<code>byte[]</code>) para
     * luego realizar el envío.
     * 
    ...
    /**
     * Clase para implementar los <code>BroadcastReceiver</code> que enviarán mensajes a la instancias de la comunicación.
     * 
     */
    public final class BaseComunicationBroadcastReceiver extends BroadcastReceiver {
    	
    	/**
    	 * Instancia de comunicación que recibirá los mensajes.
    	 */
    	private NbCom mCom;
    	
    	/**
    	 * Constructor.
    	 * En el constructor se debe indicar la instancia de comunicación que recibirá los mensajes de
    	 * <code>BroadcastReceiver</code>.
    	 * 
    	 * @param com 	Instancia de <code>BaseComunication</code> que recibirá los mensajes.
    	 */
