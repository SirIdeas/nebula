...
public class NbSketch extends NbCmpVector implements NbPerformer{
	...
	/**
	 * Indica que sedebe sincronizar las salidas cuando cuando se llame la funcion play;.
	 */
	 ...
	 * @throws NbBuffer.ReadException	Se generá un error cuando se intente obtener datos
	 ...
	 * Esta función se se tomar los bytes del buffer y procesaros. Deberá retornar <code>true</code> si culmina el
	 * procesamiento exitosamente. En el caso de que el buffer se haya quedado vacío antes de terminar el procesamiento
	 * (hicieron faltas bytes) entonces esta función deberá retornar <code>false</code>. 
	 * 
