/* ========================================================================
 * Nebula Android Lib: NbAdk v0.0.1-beta
 ...
 * tipo Serial. Básicamente consiste en métos que permiten realizar este tipo de comunicación.
 * 
 */
@SuppressLint("NewApi")
public class NbAdk extends NbCom {
	...
	/**
	 * Constructor.
	 * Inicializa los paramétros necesario para el funcionamiento mínimo de la instancia.
	 * 
...
//		mUsbManager = UsbManager.getInstance(context);
	 ...
	 * @return		Instancia del accesorio o <code>null</code> si la posicion es inválida. 
	 */
     ...
     * Este método permite cancelar la conexión actual. Tambien se cambia el estado de la conexión y se genera el evento
     * correspondiente.
     */
	@Override
     ...
     * Para esta especificación se recibe la respuesta de solicitud de permisos para conectarse a los accesorios y recive aviso
