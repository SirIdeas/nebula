...
<pre><code class="language-html"><?php echo getCodeFile("manifest-bt-permissions") ?></code></pre>
...
<div class="row">
  <div class="col-md-8">
    ...
    <pre><code class="language-java"><?php echo getCodeFile("android-bt-simple-list-acivity-class") ?></code></pre>
    ...
    <pre><code class="language-html"><?php echo getCodeFile("android-bt-simple-list-acivity-manifest") ?></code></pre>
...
<pre><code class="language-java"><?php echo getCodeFile("bt-led-blink-main-activity-class") ?></code></pre>
